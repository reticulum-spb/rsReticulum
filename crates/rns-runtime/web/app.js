...
function interfaceDetails(item) {
  ...
  details.append(
    ...
    detailItem("Protocol violations", formatNumber(item.protocol_violations)),
    detailItem("IFAC violations", formatNumber(item.ifac_violations)),
    detailItem("Packet filter hits", formatNumber(item.packet_filter_hits)),
